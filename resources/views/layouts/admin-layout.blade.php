        ...
        <nav id="sidebar" class="sidebar-wrapper">
            <div class="sidebar-content">
                ...
                <div class="sidebar-header">
                    ...
                    <div class="user-info">
                        <h4 style="color: white">Welcome {{\App\User::where('id', \Illuminate\Support\Facades\Session::get('userId'))->first()['name'] ?? 'Admin'}}</h4>
                    </div>
                </div>
                ...
                <div class="sidebar-menu">
                    <ul>
                        ...
                        <li class="" style="border: 1px solid white;border-bottom: 0px;padding: 5px;font-size: 15px">
                            <a href="{{url('/all-classifieds')}}">
                                {{--                                <i class="fa fa-ad"></i>--}}
                                <span>All Classifieds</span>
                            </a>
                        </li>
                        <li class="" style="border: 1px solid white;border-bottom: 0px;padding: 5px;font-size: 15px">
