...
<section class="section trend-part" style="margin-bottom: 100px">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-center-heading"><h2>All <span>Movies</span></h2>
                        <a href="{{url('')}}" style="color:#000;text-decoration: underline">Home</a> > <a href="#" style="color:#000;">All Movies</a>
                    </div>
                    <div style="float: right;margin-bottom: 10px">
                        <a href="{{url('add-movie')}}" class="btn btn-primary">POST MOVIES AD</a>
                    </div>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="product-card inline">
                            <div class="product-head">
                                <div class="product-img"
                                     style="background:url({{url('get-movie-photo')}}/{{$item->id}}) no-repeat center; background-size:cover;"><i
