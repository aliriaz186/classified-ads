...
@section('content')
    <style>
        ...
        .sent_msg p {
            background: #383f44 none repeat scroll 0 0;
            border-radius: 3px;
            font-size: 14px;
            margin: 0;
            color: #fff;
                            ...
                            @if($myEmail == $chat->sender)
                                <div class="outgoing_msg">
                                    <div class="sent_msg">
                                        ...
                                        <span
                                            class="time_date"> {{$chat->created_at}}    |    <?php echo \Carbon\Carbon::createFromTimeStamp(strtotime($chat->created_at))->diffForHumans() ?></span>
                                    </div>
                                </div>
                            @else
