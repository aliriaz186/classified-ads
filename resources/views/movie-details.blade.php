...
@section('content')
    ...
    <section class="single-banner">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="single-content"><h2>{{$movie->title}} details</h2>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{url('')}}">Home</a></li>
                            <li class="breadcrumb-item"><a href="{{url('movies')}}">All Movies</a></li>
    ...
    <section class="ad-details-part">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="ad-details-card">
                        <div class="ad-details-breadcrumb">
                            <ol class="breadcrumb">
                                <li><span class="flat-badge sale">Movie</span></li>
                        ...
                        <ul class="ad-details-meta">
                            ...
                            <li><a href="#"><i class="fas fa-star"></i>
                                    <p>comments<span>({{count($movie->comments)}})</span></p></a></li>
                            {{--                            <li><a href="#"><i class="fas fa-heart"></i>--}}
                            {{--                                    <p>bookmark<span>(15)</span></p></a></li>--}}
                        </ul>
                        <div class="ad-details-slider slider-arrow">
                            <div><img src="{{url('/get-movie-photo')}}/{{$movie->id}}" alt="details"></div>
                    ...
                    <div class="ad-details-card">
                        <div class="ad-details-title"><h5>Comments ({{count($movie->comments)}})</h5></div>
                        <div class="ad-details-review">
                            <ul class="review-list">

                                @foreach($movie->comments as $item)
                            ...
                            @if(\Illuminate\Support\Facades\Session::has('userId'))
                                ...
                                {{--                                    </div>--}}
                                {{--                                </form>--}}
                                <form class="ad-review-form" action="{{url('post-movie-comment')}}" method="post">
                                    @csrf
                ...
                <div class="col-lg-4">
                    <div class="ad-details-price"><h5 style="font-size: 15px">{{$movie->email}}</h5>
                    </div>
                    <button class="ad-details-number"><i class="fas fa-phone-alt"></i><span>{{$movie->phone}}</span>
                    </button>
                    <div class="ad-details-card">
