...
{{--    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@9"></script>--}}
    ...
    <style>
        .login-block{
            background: #383f44;  /* fallback for old browsers */
        ...
        .login-sec .copy-text i{color:#383f44;}
        .login-sec .copy-text a{color:#383f44;}
        .login-sec h2{margin-bottom:30px; font-weight:800; font-size:30px; color: #383f44;}
        .login-sec h2:after{content:" "; width:100px; height:5px; background:#383f44; display:block; margin-top:20px; border-radius:3px; margin-left:auto;margin-right:auto}
        .btn-login{background: #383f44; color:#fff; font-weight:600;}
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 login-sec">
                ...
                <h2 class="text-center" style="text-transform: uppercase">{{env('APP_NAME')}}</h2>

                <h3 class="text-center">Login Now</h3><br>
